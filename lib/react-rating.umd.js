(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('rc-tooltip')) :
  typeof define === 'function' && define.amd ? define(['react', 'rc-tooltip'], factory) :
  (global = global || self, global.ReactRating = factory(global.React, global.Tooltip));
}(this, (function (React, Tooltip) { 'use strict';
  ...
  var Style = {
    empty: _objectSpread2({}, style, {
      backgroundColor: '#ccc'
    }),
    full: _objectSpread2({}, style, {
      backgroundColor: 'black'
    }),
    placeholder: _objectSpread2({}, style, {
      backgroundColor: 'red'
    })
  };
    ...
    _createClass(Rating, [{
      ...
      value: function render() {
        ...
        for (var i = 0; i < totalSymbols; i++) {
          ...
          var renderTooltip = showTooltip && interacting && i + 1 === Math.ceil(renderedValue);
...
//# sourceMappingURL=react-rating.umd.js.map
